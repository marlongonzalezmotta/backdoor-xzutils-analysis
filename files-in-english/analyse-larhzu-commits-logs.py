...
author_data = load_and_process_data('lasse-collin-logs.json', 'lasse.collin@tukaani.org')
...
print(f'Analysis for lasse.collin@tukaani.org:')
print()
print(f'---Result of average commits per day from {start_date} to {end_date}:---')
print(f'Total commits analyzed: {total_commits}.')
print(f'Median commit time is {decimal_to_time(median_time)} hours.')
print(f'Mean commit time is {decimal_to_time(mean_time)} hours.')
...
print()
print(f'---Result of average commits by day of the week from {start_date} to {end_date}---')
