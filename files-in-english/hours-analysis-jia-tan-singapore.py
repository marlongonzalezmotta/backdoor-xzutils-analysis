...
author_data = load_and_process_data('jia-tan-logs.json', 'jiat0218@gmail.com')
...
print()
print(f'---Result of average commits by them from EVERY DAY from {start_date} to {end_date}:---')
print(f'Total commits analyzed are {total_commits}.')
...
print()
print(f'---Result of average WEEKDAY commits from {start_date} to {end_date}---')
